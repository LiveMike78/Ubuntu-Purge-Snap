...
```bash
curl -sSL [https://raw.githubusercontent.com/YOUR_GITHUB_USERNAME/ubuntu-purge-snap/main/purge-snap.sh](https://raw.githubusercontent.com/YOUR_GITHUB_USERNAME/ubuntu-purge-snap/main/purge-snap.sh) | sudo bash